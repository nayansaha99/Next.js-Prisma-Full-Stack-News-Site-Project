...
const Subscribe = () => {
    ...
    return (
        <div className="card p-3 shadow-sm border border-danger">
            ...
            <input  value={data.email} onChange={(e)=>{inputOnChange('email',e.target.value)}} type="text" placeholder="Email Address" className="form-control mb-3 border border-danger"/>
